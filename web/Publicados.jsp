...
<body>
    ...
    <div class="col-md-12" >
        <center><p class=" panel-heading bg-primary text-primary" >ELIMINAR FORMULARIOS PUBLICADOS.</p></center>
    </div>
<center> 
        ...
        <div>
            <form action="" method="POST" target="_self" id="mr" style="display:inline;">
                <div class="row">
                    <div class="col-xs-12 col-md-4">
                        <div class="form-group has-success has-feedback">
                            <span id="helpBlock" class="help-block">1.- Ingrese el ID del usuario al cual desea eliminar un Formulario: </span><label class="control-label col-sm-3" for="inputGroupSuccess2">ID: </label>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-4">
                        <div class="form-group has-success has-feedback">
                            <span id="helpBlock" class="help-block">2.- Seleccione el formulario a eliminar : </span>             
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-8">
                    </div>
