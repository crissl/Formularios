        ...
        <p></p><div class="tab-content">
            <div class="tab-pane fade" id="obligatorio">
                <%    //FORMULARIOS OBLIGATORIOS
                    ...
                    ResultSet resu2 = coo.prepareStatement("select p.codigo_uzgtformularios from UTIC.UZGTFORMULARIO_PERSONA p,UTIC.UZGTFORMULARIOS f where p.spriden_pidm =" + pidm + "and p.codigo_uzgtformularios = f.codigo_uzgtformularios and (  p.uzgtformularios_estado_llenado ='N' or f.uzgtformularios_estado_llenado ='S' or f.uzgtformularios_estado_llenado ='M' )  ORDER BY codigo_UZGTFORMULARIOS ASC").executeQuery();
                    while (resu2.next()) {
            ...
            <%//Muestra los Formularios llenados del Usuario
                ...
                ResultSet resu3 = coo.prepareStatement("select p.codigo_uzgtformularios from UTIC.UZGTFORMULARIOS f, UTIC.UZGTFORMULARIO_PERSONA p where p.codigo_uzgtformularios = f.codigo_uzgtformularios and f.UZGTFORMULARIOS_FECHA_FIN >= to_CHAR(current_Date, 'DD/MM/RRRR') and f.uzgtformularios_estado_llenado ='M' AND p.spriden_pidm ='" + PIDMget + "' ORDER BY codigo_UZGTFORMULARIOS ASC ").executeQuery();
                while (resu3.next()) {
                ...
                <center><div class="row">
                    ...
                    <%            //Muestra los Formularios por llenar del Usuario
                        ...
                        for (int i = 0; i < listaF3.size(); i++) {
                            ...
                            out.print("<div class=\"col-xs-4 col-sm-2 col-md-2\"><p id=\"cod\"><center>" + listaF3.get(i).getCodigo_formulario() + "</p></div>");
                    ...
                    <%
                        ...
                        if (listaF5.isEmpty()) {
                            ...
                            for (int i = 0; i < listaF5.size(); i++) {
                                ...
                                out.println("<center><div class=\"row\">");
                                out.print("<div class=\"col-xs-4 col-sm-2 col-md-2\"><p id=\"cod\"><center>" + listaF5.get(i).getCodigo_formulario() + "</center></p></div>");
                                out.print("<div class=\"col-xs-4 col-sm-8 col-md-8\"><p name=\"nombre\"><center>" + listaF5.get(i).getNombre_formulario() + "</center></p></div>");
            ...
            <%             } catch (Exception e) {
                    System.out.println("ERROR Gres Usuarios:  " + e);
                }
            %>
        </div>
    </body>
