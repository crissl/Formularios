...
<body>  
    <form action="1.jsp" method="POST">
        <div class="container">
            ...
            <h6>*DATOS GENERALES DEL TUTOR DE ACOMPAÑAMIENTO ACADÉMICO.<span class="label label-default"></span></h6>
...
<div class="container">
    ...
    <div class="col-md-12">
        <h6>*INGRESE LA INFORMACIÓN REFERENTE A LA TUTORÍA DE ACOMPAÑAMIENTO ACADÉMICO<span class="label label-default"></span></h6>
    </div>
    <div class="form-group">
